...
$blacklist = array(
    'laiki', 'epadomi', 'edienbots', 'gardedis_lv', 'LA_lv', 'JaunsLV', 'FOLKKLUBS', 'ltvzinas', 
	'integreta_bibl', 'receptes_eu', 'TautaRuna', 'zinicenu', 'StilaparksLv', 'ifaktors', 'nralv', 
	'DelfiLV', 'Twitediens', 'budzis', 'cafeleningrad', '8Lounge1', 'VidzAugstskola', 'IntaMolodcova', 
...
$priduraki = array(
    ...
    'BlackHalt', 'Amazonenozam', 'Michellv1970', 'Rezhgjis', '7no4user', 'ancetarvida', 'gina_x_gina'
);